...
class Property
{
    ...
    // Privilégier l'usage de la bdd plutôt que des constantes si les valeurs viennent à changer
    const HEAT = [
        0 => 'Electrique',
        1 => 'Gaz'
    ];

    // ID = clé primaire, générée automatiquement et auto incrémentée par la base de données, colonne de type entier
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
